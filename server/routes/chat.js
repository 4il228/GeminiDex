...
const TIER_MODELS = {
  free:  { models: ['gemini-3.5-flash', 'gemini-2.5-flash'], maxTokens: 65000, contextLimit: '1M' },
  pro:   { models: ['gemini-3.5-flash', 'gemini-2.5-pro', 'gemini-2.5-flash'], maxTokens: 65000, contextLimit: '1M' },
  ultra: { models: ['gemini-3.5-flash', 'gemini-2.5-pro', 'gemini-2.5-flash', 'gemini-1.5-pro'], maxTokens: 100000, contextLimit: '1M+' }
};
